...
Beim Start postet der Bot automatisch das Dropdown-Menü im Bewerbungs-Kanal.

⚠️ Hinweis: Der Bot postet das Menü bei **jedem Neustart** erneut. Wenn du das nicht willst, kommentiere den Aufruf `postDropdown()` nach dem ersten erfolgreichen Posten im Code aus, oder lösche die alte Nachricht manuell.
